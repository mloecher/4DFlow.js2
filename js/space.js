FLOW.Space = function() {
    ...
    // Camera
    this.camera = new THREE.PerspectiveCamera( 30, this.container.offsetWidth / this.container.offsetHeight, .1, 5000 );
...
FLOW.Space.prototype.add_plane = function(request) {
    ...
    plane.applyMatrix(new THREE.Matrix4().makeTranslation(xpos, ypos, zpos));
